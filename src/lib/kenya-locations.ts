...
export const LOCATION_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  Ruiru: { lat: -1.1450, lng: 36.9634 },
  Naivasha: { lat: -0.7172, lng: 36.4318 },
  Eldoret: { lat: 0.5143, lng: 35.2698 },
  Nyeri: { lat: -0.4201, lng: 36.9476 },
  Nanyuki: { lat: 0.0167, lng: 37.0731 },
  Laikipia: { lat: 0.3606, lng: 36.7820 },
  Diani: { lat: -4.2767, lng: 39.5934 },
  Malindi: { lat: -3.2175, lng: 40.1191 },
  Kilifi: { lat: -3.6305, lng: 39.8499 },
  Kwale: { lat: -4.1747, lng: 39.4521 },
  Meru: { lat: 0.0463, lng: 37.6559 },
  Muranga: { lat: -0.7210, lng: 37.1526 },
  Kericho: { lat: -0.3689, lng: 35.2831 },
  Karen: { lat: -1.3192, lng: 36.7085 },
