...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Foxwood Properties — Prime real estate in Kenya" },
      { property: "og:description", content: "Find your perfect property in Kenya. Verified listings, trusted agents, easy search." },
